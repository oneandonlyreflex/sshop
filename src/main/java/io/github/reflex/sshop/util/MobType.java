...
public class MobType {
    ...
    static {
        ...
        entityTypeMap.put(EntityType.OCELOT, "MHF_Ozelot");
        ...
        entityTypeMap.put(EntityType.PIG_ZOMBIE, "MHF_PigZombie");
        entityTypeMap.put(EntityType.IRON_GOLEM, "MHF_Golem");
        entityTypeMap.put(EntityType.PIG, "MHF_Pig");
        entityTypeMap.put(EntityType.SHEEP, "MHF_Sheep");
        entityTypeMap.put(EntityType.ZOMBIE, "MHF_Zombie");
        ...
        entityTypeMap.put(EntityType.WITHER, "MHF_Wither");
        ...
        entityTypeMap.put(EntityType.SQUID, "MHF_Squid");
